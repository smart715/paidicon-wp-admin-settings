  ...
  function previewFile() {
    ...
    return (
        <>
                                                ...
                                                <div className="notif-iconn_mainn">
                                                    <div className='svg_notif'>
                                                        <svg width="28" height="28" viewBox="0 0 28 28">
                                                            ...
                                                            <g id="vuesax_bulk_notification-bing" data-name="vuesax/bulk/notification-bing" transform="translate(-108 -188)">
                                                                <g id="notification-bing" transform="translate(108 188)">
                                                                    <path id="Vector" d="M19.786,16.66A3.062,3.062,0,0,1,17.873,18.5a25.934,25.934,0,0,1-3.862.957c-.128.023-.257.047-.385.058-.21.035-.42.058-.63.082-.257.035-.525.058-.793.082-.735.058-1.458.093-2.193.093s-1.493-.035-2.228-.1c-.315-.023-.618-.058-.922-.1-.175-.023-.35-.047-.513-.07-.128-.023-.257-.035-.385-.058a24.121,24.121,0,0,1-3.827-.945A3.1,3.1,0,0,1,.175,16.66,3.1,3.1,0,0,1,.478,14L1.8,11.807a4.775,4.775,0,0,0,.537-1.96V7.677a7.671,7.671,0,1,1,15.342,0v2.17a4.615,4.615,0,0,0,.548,1.96L19.541,14A3.1,3.1,0,0,1,19.786,16.66Z" transform="translate(4.014 2.392)" opacity="0.4" fill="url(#linear-gradient)" />
                                                                    <path id="Vector-2" data-name="Vector" d="M.887,5.39A.886.886,0,0,1,0,4.5V.887a.887.887,0,0,1,1.773,0V4.5A.9.9,0,0,1,.887,5.39Z" transform="translate(13.113 7.163)" fill="url(#linear-gradient)" />
                                                                    <path id="Vector-3" data-name="Vector" d="M6.592.012a3.517,3.517,0,0,1-3.3,2.322A3.459,3.459,0,0,1,.817,1.3,3.221,3.221,0,0,1,0,0C.152.023.3.035.467.058c.268.035.548.07.828.093C1.96.21,2.637.245,3.313.245S4.643.21,5.3.152c.245-.023.49-.035.723-.07Z" transform="translate(10.71 23.333)" fill="url(#linear-gradient)" />
                                                                    <path id="Vector-4" data-name="Vector" d="M0,0H28V28H0Z" fill="none" opacity="0" />
                                                                </g>
                                                            </g>
                                                        </svg>
            ...
            {/* <button type="button" className="btn btn-primary mt-lg-3" data-bs-toggle="modal" data-bs-target="#exampleModalregister">
                Register Now
            </button>
                       ...
                       <div className='px-3'>
                        <div className='licence-form position-relative'>
                            ...
                            <div className='licence-form-r position-relative'>
                                ...
                                <span className='must-we-r-l position-absolute'>Must Be UUID4 With 32 Characters</span>
                            </div>
                            <div className='licence-form-r position-relative'>
                            ...
                            <div className='licence-form-r-k position-relative'>
                                <input type="text" className="form-controll" id="exampleFormControlInput1" placeholder="Refferrer" />
            ...
            <div id='payment' className={newlink === 'payment' ? " " : "display-none"}>
                ...
                <div className="header-title-main  bg-light">
                    <div className="header-title-main-inner pb-lg-4 container ">
                        <h1 className="mb-0 py-4 page-titlee text-center  text-md-left">Payment</h1>
